...
public class RecycleFoodList extends RecyclerView.Adapter<RecycleFoodList.FoodViewHolder>  {
    ...
    public static class FoodViewHolder extends RecyclerView.ViewHolder{
        ...
        public FoodViewHolder(@NonNull View itemView) {
            ...
            price=(TextView)itemView.findViewById(R.id.foodpric);
            qty=(TextView)itemView.findViewById(R.id.foodqty);
            imageView=(ImageView)itemView.findViewById(R.id.food_image);
        }
    }


    public RecycleFoodList(List<Food>food,Context context) {
        this.items=food;
    ...
    @NonNull
    @Override
    public RecycleFoodList.FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecycleFoodList.FoodViewHolder holder, int position) {
