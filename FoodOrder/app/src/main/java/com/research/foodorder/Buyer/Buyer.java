        ...
        navController.addOnDestinationChangedListener(new NavController.OnDestinationChangedListener() {
            ...
            public void onDestinationChanged(@NonNull NavController controller, @NonNull NavDestination destination, @Nullable Bundle arguments) {
                if (destination.getId() == R.id.nav_home) {
                    Toast.makeText(Buyer.this, "home", Toast.LENGTH_LONG).show();
                }
                if (destination.getId() == R.id.nav_gallery) {
                    Toast.makeText(Buyer.this, "nav_gallery", Toast.LENGTH_LONG).show();
                }
                if (destination.getId() == R.id.nav_tools) {
                    Toast.makeText(Buyer.this, "nav_tools", Toast.LENGTH_LONG).show();
                }
                if (destination.getId() == R.id.nav_share) {
                    Toast.makeText(Buyer.this, "nav_share", Toast.LENGTH_LONG).show();
                }
                if (destination.getId() == R.id.nav_send) {
                    Toast.makeText(Buyer.this, "nav_send", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
